...
*/
	...
	*/
	...
	curl
		...
		-d '{"name": "name", "propertyType": "ROOM", "price": 1.2, "extraPricePerPerson": 2,"beds": 1, "bedrooms": 1, "bathrooms": 1, "minimumDays": 1, "maximumTenants": 1, "propertySize": 1, "freeText": "la la", "aircondition": "True",  "tv": "True", "internet": "True", "livingRoom": "True", "kitchen": "True", "partyFriendly": "True", "petFriendly": "True", "smokingFriendly": "True", "extraFreeText": "", "longitude": -74.00898606, "latitude": 40.71727401, "availableDates": [{"availableFrom": "2010-12-12", "availableTo": "2020-01-12"}], "countryId": 1, "cityId": 1, "districtId": 1 }'
	...
	*/
	...
	public ResponseEntity<?> updateProperty(
		...
		airbnbManager.updateProperty( propertyUpdateRequest, propertyId, userId );
	...
	*/
	...
	curl
		...
		-d '{"from": "2020-06-08", "to": "2020-06-08", "numberOfPeople": 3, "countryId": "1", "cityId": "1", "districtId": "1", "propertyType": "ROOM", "pagination": {"limit": 0, "offset": 1}  }'
