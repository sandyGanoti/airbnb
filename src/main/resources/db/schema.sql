...
CREATE TABLE IF NOT EXISTS `airbnb`.`property` (
  ...
  PRIMARY KEY(`id`),
  KEY fk_property_user (landlord_id),
  CONSTRAINT fk_property_user FOREIGN KEY (landlord_id) REFERENCES user (id)
);
...
INSERT INTO `airbnb`.`property`(id, name, country, city, region, landlord_id, price, beds, bedrooms, bathrooms, minimum_days, minimum_tenants, maximum_tenants, property_size, free_text) values(1, "A great place to stay by the sea", "Greece", "Athens", "Melissia", 1, 29.34, 2, 2, 2, 4, 2, 4, 32, NULL);
INSERT INTO `airbnb`.`property`(id, name, country, city, region, landlord_id, price, beds, bedrooms, bathrooms, minimum_days, minimum_tenants, maximum_tenants, property_size, free_text) values(2, "A nice house", "Greece", "Athens", "Patisia", 2, 29.34, 5, 3, 2, 2, 3, 3, 30, NULL);
INSERT INTO `airbnb`.`property`(id, name, country, city, region, landlord_id, price, beds, bedrooms, bathrooms, minimum_days, minimum_tenants, maximum_tenants, property_size, free_text) values(3, "Another nice house", "Greece", "Athens", "Agios Stefanos", 3, 200, 1, 1, 1, 1, 1, 1, 28, "A nice place to stay");
INSERT INTO `airbnb`.`property`(id, name, country, city, region, landlord_id, price, beds, bedrooms, bathrooms, minimum_days, minimum_tenants, maximum_tenants, property_size, free_text) values(4, "A beautiful house", "Greece", "Athens", "Patisia", 1, 32, 1, 1, 3, 1, 1, 3, 34, "Another nice place to stay");
